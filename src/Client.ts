...
import type { AproxConfig, Metadata } from "aprox-api/src";

import { API, MemberCompositeKey, Role } from "aprox-api/src";
...
export class Client extends EventEmitter {
    ...
    /**
     * Whether aprox.js should auto-reconnect
     */
    get autoReconnect() {
    ...
    /**
     * Use an existing session to log into Aprox.
    ...
    /**
     * Log out of Aprox. Disconnect the WebSocket, request a session invalidation and reset the client.
     */
